...
3. If appropriate, call `list_memories` to browse all stored memories for this user.
...
1. Call `search_memory` with a query related to the current task to refresh relevant memories.
...
1. Call `search_memory` with queries related to what you were working on to reload relevant knowledge.
