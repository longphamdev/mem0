...
This project is indexed by GitNexus as **mem0** (24283 symbols, 38962 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
